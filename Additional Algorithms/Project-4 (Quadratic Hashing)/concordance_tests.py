...
class TestList(unittest.TestCase):
    ...
    def test_04(self) -> None:
        ...
        with self.assertRaises(FileNotFoundError):
            conc.load_concordance_table("no_file.txt")

    def test_05(self) -> None:
        conc = Concordance()
        conc.load_stop_table("stop_words.txt")
        conc.load_concordance_table("amogus.txt")
        conc.write_concordance("amogus_con.txt")
        self.assertTrue(compare_files("amogus_con.txt", "amogus_sol.txt"))
