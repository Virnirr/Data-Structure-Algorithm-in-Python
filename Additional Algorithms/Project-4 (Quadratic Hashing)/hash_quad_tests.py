...
class TestList(unittest.TestCase):
    ...
    def test_05(self) -> None:
        ...
        self.assertEqual(ht.get_index("mouse"), 14)
        self.assertEqual(ht.get_index("elephant"), 9)
        self.assertEqual(ht.get_index("sussx"), None)
        keys = ht.get_all_keys()
        keys.sort()
        self.assertEqual(keys, ["cat", "dog", "elephant", "hop", "mouse"])
        self.assertEqual(ht.in_table("cat"), True)
        self.assertEqual(ht.in_table("sussx"), False)
        self.assertEqual(ht.get_value("cat"), [5])
        self.assertEqual(ht.get_value("sussx"), None)
